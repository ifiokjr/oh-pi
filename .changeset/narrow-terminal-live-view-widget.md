...
# Narrow Terminal Live View Widget

Clamp pi-bash-live-view widget lines to the active terminal width so narrow TUI sessions do not crash when rendering long PTY output.
