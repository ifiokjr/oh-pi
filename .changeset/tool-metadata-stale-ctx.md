...
# Tool Metadata Stale Ctx

Skip session context metadata when pi reports a stale extension context after session replacement or reload, and update the basic-ftp security override.
