...
# Watchdog Stale Timer Gaps

Ignore stale watchdog event-loop samples after long timer gaps so process sleep or suspension does not trigger critical lag alerts.
