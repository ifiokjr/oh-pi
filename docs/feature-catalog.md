...
| `auto-session-name`      | automatic session titles, better compaction continuity                              | Names sessions from user intent, keeps titles fresh as focus changes, and continues after compaction                                          |
