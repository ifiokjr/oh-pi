 ...
 *
 * Adapted from mitsuhiko/agent-stuff extensions/goal.ts.
...
const USAGE_ERROR_RE = /\b(usage|rate|quota|limit)\b/i;

function goalStopStatusForAssistantError(message: { errorMessage?: string } | undefined): GoalStatus {
	const errorMessage = message?.errorMessage ?? "";
	return USAGE_ERROR_RE.test(errorMessage) ? "usageLimited" : "blocked";
}
